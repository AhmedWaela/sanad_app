...
import 'package:sanad_app/features/tasks/presentation/views/widgets/calender_date_picker.dart';
...
class _DatePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double scaledFontSize =
        MediaQuery.textScalerOf(context).scale(titleStyle?.fontSize ?? 32);
...
Future<DateTimeRange?> showDateRangePicker({
  ...
  assert(
    initialDateRange == null ||
        selectableDayPredicate == null ||
        selectableDayPredicate(initialDateRange.start, initialDateRange.start,
    ...
    final bool isDisabled = dayToBuild.isAfter(widget.lastDate) ||
        ...
        widget.selectableDayPredicate != null &&
            !widget.selectableDayPredicate!(
                dayToBuild, widget.selectedDateStart, widget.selectedDateEnd);
