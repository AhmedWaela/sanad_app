...
const double _kTimePickerDialPadding = 0;
...
class _HourMinuteControl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      height: height,
      child: Material(
        color: isSelected ? AppColors.kMintGreen : const Color(0xffEDEDED),
...
class _DayPeriodControl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final OutlinedBorder resolvedShape = RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(4.0),
        side: const BorderSide(width: 1, color: AppColors.kCoolGrey));
...
class _AmPmButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      color: selected ? AppColors.kMintGreen : Colors.transparent,
      child: InkWell(
          ...
          child: Center(
            child: Text(
              ...
              style: TextStyle(
                  ...
                  color: selected ? AppColors.kPrimaryColor : Colors.grey),
...
class _DialState extends State<_Dial> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    Color dialHandColor = AppColors.kPrimaryColor;
